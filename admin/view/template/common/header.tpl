...
<head>
<meta charset="UTF-8" />
<title><?php //echo $title; ?>Jagatradevi Store</title>
...
<div id="container">
    <div id="header">
  <div class="div1">
    <div class="div2"><img src="view/image/logo.png" title="<?php// echo $heading_title; ?>Jagatradevi Store" onclick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
